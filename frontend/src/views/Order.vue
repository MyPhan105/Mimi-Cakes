    ...
    return {
      ...
      cakes: [
        { name: "Lavender Dream", 
          ...
          sizes: [
          { label: "5 inch", price: 90, cake_id: 1},
          { label: "6 inch", price: 120, cake_id: 2},
          { label: "8 inch", price: 175, cake_id: 3},
          ],
         },
        ...
        { name: "Succulent Island",
          ...
          sizes: [
          { label: "5 inch", price: 90, cake_id: 6},
          { label: "6 inch", price: 120, cake_id: 5},
          { label: "8 inch", price: 175, cake_id: 4},
          ],
        },
        ...
        { name: "Dreammy Fairy",
          ...
          sizes: [
          { label: "5 inch", price: 90, cake_id: 7},
          { label: "6 inch", price: 120, cake_id: 8},
          { label: "8 inch", price: 175, cake_id: 9},
          ],
        },
      ],
